  ...
  return (
    <div className="mx-auto lg:max-w-7xl px-10 py-10">
      ...
      <p className="mt-2 text-2xl">
        {t("Do you have a question, concern, idea, feedback, or problem? If you need assistance, please fill out the form below and we'd be happy to help!")}
      </p>

      <div className="flex flex-wrap justify-center lg:flex-nowrap lg:justify-between mt-8 md:mt-16">
        <div>
         
            <p className="text-2xl font-semibold mb-4">{t("Type of contact")}</p>
        ...
        {t("I am interested in Healing Online for my organization.")}
        </label><br/>
        <label htmlFor="ques7">
        ...
        {t("I have a billing related question.")}
           ...
           placeholder:pl-1 "
            ...
            <label className=" flex flex-col" htmlFor="email">
              <span className="mb-5 text-2xl font-normal pt-5">{t("Email")}:</span>
              <input
                 type="email"
                 name="email"
           ...
           placeholder:pl-1"
            ...
            <label className=" flex flex-col" htmlFor="details">
              <span className="mb-5 text-2xl font-normal pt-5">{t("Details")}:</span>
              <input
                type="text"
        ...
        <div className="flex flex-col">
          ...
          <div className="mx-auto mt-9 lg:my-auto lg:align-middle">
            <div className="flex flex-col bg-[#EAF8F9] border-2 border-[#EAF8F9] rounded-xl h-70 lg:h-auto p-8 w-auto sm:w-96 lg:w-80 xl:w-96 text-2xl sm:ml-2 ">
              <h1 className="font-normal pb-3">{t("Find Us At")}:</h1>
