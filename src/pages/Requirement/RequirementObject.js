export const WhyWorkWithHealingObject = [
  {
    id: 1,
...
export const RequirementsObject = [
  {
    id: 1,
    text: 'Licensed by a State Board to provide counseling',
  },
  {
    id: 2,
    text: 'Experience in counseling for adults, couples, and/or teens',
  },
  {
    id: 3,
  ...
  {
    id: 5,
    text: 'Currently residing in the US',
  },
];
